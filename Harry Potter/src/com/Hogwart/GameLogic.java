...
public class GameLogic {
    ...
    public static void continueJourney(){
        ...
        if(act == 1){
            ...
            battle(new Enemy(enemies[1],15));
            //let the player "level up"
            wizard.chooseTrait();
            wizard.usePotion(new Potion(5));
